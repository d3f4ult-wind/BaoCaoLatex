...
{\textbf{\Large{Xây dựng hệ thống tường lửa kết hợp thông minh dựa trên công nghệ XDP/eBPF}}\\[1cm]

{\textbf{\large{LÊ NAM PHONG}}}\\
{\large{Phong.LN225149@sis.hust.edu.vn}}\\[0.5cm]

{\textbf{\large{Chương trình đào tạo: Công nghệ thông tin - Kỹ thuật máy tính
}}}\\
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
 \multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & ThS. Nguyễn Quốc Khánh \hspace{0.5cm} 
  \\[0.5cm]
